                                            ...
                                            <td style="padding-bottom:15px;padding-left:15px;padding-right:15px;padding-top:30px;">
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 36px;"><span style="font-size:24px;color:#d4ac6c;"><strong>Dear {{ $success->name }}</strong></span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                        <p style="margin: 0; font-size: 14px; text-align: center;">
                                                            We confirm the reception of your questions related to the order n°: {{ $success->order_id }}.<br/>Our entire team remains at your disposal to answer any questions, or take note of your additional comments.
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
