                                            ...
                                            <td style="padding-bottom:15px;padding-left:15px;padding-right:15px;padding-top:30px;">
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 36px;"><span style="font-size:24px;color:#d4ac6c;"><strong>Cher {{ $user->firstname }} {{ $user->lastname }}</strong></span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div align="center" style="font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;">
                                                    <table style="font-family: arial, sans-serif; border-collapse: collapse; width: 90%; margin-left: auto; margin-right: auto; font-size: 13px;">
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Numéro de réservation:</td>
                                                        ...
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Date et heure:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->date }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">De:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->pickupaddress }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;;">À:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->dropoffaddress }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Durée:</td>
                                                        ...
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Panneau d'accueil:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->pickupsign}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Votre code de référence:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->referencecode }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Numéro de vol:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->flight }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Requêtes spécifiques:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->notes }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Passager:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->firstname }} {{ $order->lastname }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Téléphone portable:</td>
