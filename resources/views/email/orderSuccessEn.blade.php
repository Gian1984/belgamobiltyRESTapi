                                            ...
                                            <td style="padding-bottom:15px;padding-left:15px;padding-right:15px;padding-top:30px;">
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 36px;"><span style="font-size:24px;color:#d4ac6c;"><strong>Dear {{ $user->firstname }} {{ $user->lastname }}</strong></span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div align="center" style="font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;">
                                                    <table style="font-family: arial, sans-serif; border-collapse: collapse; width: 90%; margin-left: auto; margin-right: auto; font-size: 13px;">
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Reservation number:</td>
                                                        ...
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Date and hour:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->date }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">From:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->pickupaddress }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;;">To:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->dropoffaddress }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Duration:</td>
                                                        ...
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Welcome panel:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->pickupsign}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Reference code:</td>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">{{ $order->referencecode }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Flight-train number :</td>
                                                        ...
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;">Passenger:</td>
                                                        ...
                                                        <tr>
                                                            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px; font-weight: 800;" >Amount:</td>
